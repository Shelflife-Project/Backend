...
public class StorageServiceDeleteStorageRequestTests {
    ...
    void deletesStorageAsAdmin() {
        ...
        assertDoesNotThrow(() -> storageService.deleteStorageRequest(1, admin));
    ...
    void deletesStorageAsOwner() {
        ...
        assertDoesNotThrow(() -> storageService.deleteStorageRequest(1, owner));
        verify(storageRepository).deleteById(1L);
    }
    ...
    void leavesStorageAsMember() {
        ...
        assertDoesNotThrow(() -> storageService.deleteStorageRequest(1, member));
    ...
    void accessDeniedAsNonMember() {
        ...
        assertThrows(AccessDeniedException.class, () -> storageService.deleteStorageRequest(1, user));
        verify(storageMemberService, only()).isMemberOfStorage(1, 2);
        verifyNoInteractions(storageRepository);
    }

    @Test
    void accessDeniedForNull() {
        assertThrows(AccessDeniedException.class, () -> storageService.deleteStorageRequest(1, null));
